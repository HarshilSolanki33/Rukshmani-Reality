  ...
  if(modal && closeBtn){
    ...
    document.querySelectorAll(".action-view").forEach(btn => {
      ...
      btn.addEventListener("click", () => {
        ...
        desc.textContent = card.querySelector(".property-desc").textContent;
        meta.textContent = card.querySelector(".property-meta").textContent;
        rent.textContent = card.querySelector(".property-rent").textContent;
