...
<head>
    ...
    <title>Grand Horizon</title>
     <link rel="icon" type="image/png" sizes="48x48" href="./Gallery/Title-img.png">
    <link rel="stylesheet" href="Assets/Grand Horizon.css">
  ...
  <div class="hero-wrapper">
    <div class="hero-left">
      <div class="hero-inner">
        <h1 class="hero-title u-underline">GRAND HORIZON</h1>

        <p class="lead">
          AT 
          <span class="rukshmani">Grand Horizon</span> a place where every sunrise brings comfort, luxury and peace. Thoughtfully planned spaces, open views and urban connectivity come together to create a lifestyle you and your family truly deserve.
        </p>
      </div>
    </div>
  </div>
...
$query = 'SELECT * FROM "Guest_User_DB".Grand_Horizon_bgremove ORDER BY id ASC';
...
$query = 'SELECT * FROM "Guest_User_DB".Grand_Horizon_Perspective ORDER BY id ASC';
...
$query = 'SELECT * FROM "Guest_User_DB".Grand_Horizon_topology ORDER BY id ASC';
...
$query = 'SELECT * FROM "Guest_User_DB".Grand_Horizon_signature ORDER BY id ASC';
...
$query = 'SELECT * FROM "Guest_User_DB".Grand_Horizon_floorplan ORDER BY id ASC';
...
<script src="Assets/Grand Horizon.js"></script>
