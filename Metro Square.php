...
<head>
    ...
    <title>Metro Square</title>
    <link rel="stylesheet" href="Assets/Metro Square.css">
  ...
  <div class="hero-wrapper">
    <div class="hero-left">
      <div class="hero-inner">
        ...
        <p class="lead">
          AT 
          <span class="rukshmani">Metro Square</span> boasts exceptional connectivity, putting everything you need right at your doorstep. It also offers spacious living, ideally located in the heart of the city.
        </p>
      </div>
    </div>
  </div>
 ...
 <section class="perspectives">
  ...
  <div class="perspectives-grid">
    ...
    <div class="perspective-card">
      <img src="gallery/Metro Square-1.jpg" alt="Night View">
      <span class="label">FRONT VIEW</span>
    </div>

    <div class="perspective-card">
      <img src="gallery/Metro Square-2.jpg" alt="Club View">
      <span class="label">CAMPUS VIEW</span>
    </div>

    <div class="perspective-card">
      <img src="gallery/Metro Square-3.jpg" alt="Plaza View">
      <span class="label">NIGHT VIEW</span>
    </div>

    <div class="perspective-card">
      <img src="gallery/Metro Square-4.jpg" alt="Side View">
      <span class="label">CLUB HOUSE VIEW</span>
    </div>
